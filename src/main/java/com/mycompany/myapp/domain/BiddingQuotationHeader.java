...
public class BiddingQuotationHeader implements Serializable {
     ...
     * 多个竞价轮次详情属于一个询报价单
     */
    @ApiModelProperty(value = "多个竞价轮次详情属于一个询报价单")
    @ManyToOne
    @JsonIgnoreProperties(value = "biddingQuotationHeaders", allowSetters = true)
    ...
    public BiddingQuotationHeader opener(Opener opener) {
        this.opener = opener;
        return this;
    }
