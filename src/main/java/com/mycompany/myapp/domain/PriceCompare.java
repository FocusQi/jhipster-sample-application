...
public class PriceCompare implements Serializable {
    ...
    public PriceCompare poHeaders(Set<PoHeader> poHeaders) {
        this.poHeaders = poHeaders;
        return this;
    }

    public PriceCompare addPoHeader(PoHeader poHeader) {
        this.poHeaders.add(poHeader);
        poHeader.setPriceCompare(this);
        return this;
    }

    public PriceCompare removePoHeader(PoHeader poHeader) {
