...
import com.mycompany.myapp.repository.BomTemplateInfoColumnRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.BomTemplateInfoColumn}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BomTemplateInfoColumnResource {
    ...
    public ResponseEntity<BomTemplateInfoColumn> createBomTemplateInfoColumn(@RequestBody BomTemplateInfoColumn bomTemplateInfoColumn) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/bom-template-info-columns/" + result.getId()))
    ...
    public ResponseEntity<BomTemplateInfoColumn> updateBomTemplateInfoColumn(@RequestBody BomTemplateInfoColumn bomTemplateInfoColumn) throws URISyntaxException {
    ...
    public List<BomTemplateInfoColumn> getAllBomTemplateInfoColumns() {
        log.debug("REST request to get all BomTemplateInfoColumns");
        return bomTemplateInfoColumnRepository.findAll();
    }
