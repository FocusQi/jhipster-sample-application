...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.BiddingQuotationHeader}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BiddingQuotationHeaderResource {
    ...
    public ResponseEntity<BiddingQuotationHeader> createBiddingQuotationHeader(@Valid @RequestBody BiddingQuotationHeader biddingQuotationHeader) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/bidding-quotation-headers/" + result.getId()))
    ...
    public ResponseEntity<BiddingQuotationHeader> updateBiddingQuotationHeader(@Valid @RequestBody BiddingQuotationHeader biddingQuotationHeader) throws URISyntaxException {
    ...
    public List<BiddingQuotationHeader> getAllBiddingQuotationHeaders() {
        log.debug("REST request to get all BiddingQuotationHeaders");
        return biddingQuotationHeaderRepository.findAll();
    }
