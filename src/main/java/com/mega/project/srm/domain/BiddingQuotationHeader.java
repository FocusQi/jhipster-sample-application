...
public class BiddingQuotationHeader implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    private Set<BiddingOpener> openers = new HashSet<>();
    ...
    public BiddingQuotationHeader priceCompare(BiddingPriceCompare biddingPriceCompare) {
    ...
    public Set<BiddingOpener> getOpeners() {
        return openers;
    }

    public BiddingQuotationHeader openers(Set<BiddingOpener> biddingOpeners) {
        this.openers = biddingOpeners;
        return this;
    }

    public BiddingQuotationHeader addOpener(BiddingOpener biddingOpener) {
        this.openers.add(biddingOpener);
        biddingOpener.setBqHeader(this);
        return this;
    }

    public BiddingQuotationHeader removeOpener(BiddingOpener biddingOpener) {
        this.openers.remove(biddingOpener);
        biddingOpener.setBqHeader(null);
        return this;
    }

    public void setOpeners(Set<BiddingOpener> biddingOpeners) {
        this.openers = biddingOpeners;
    }
