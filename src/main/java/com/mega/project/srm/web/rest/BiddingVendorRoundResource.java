...
/**
 * REST controller for managing {@link com.mega.project.srm.domain.BiddingVendorRound}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BiddingVendorRoundResource {
    ...
    public ResponseEntity<BiddingVendorRound> createBiddingVendorRound(@RequestBody BiddingVendorRound biddingVendorRound)
        ...
        return ResponseEntity
            .created(new URI("/api/bidding-vendor-rounds/" + result.getId()))
    ...
    public ResponseEntity<BiddingVendorRound> updateBiddingVendorRound(@RequestBody BiddingVendorRound biddingVendorRound)
        throws URISyntaxException {
    ...
    public ResponseEntity<List<BiddingVendorRound>> getAllBiddingVendorRounds(Pageable pageable) {
        log.debug("REST request to get a page of BiddingVendorRounds");
        Page<BiddingVendorRound> page = biddingVendorRoundRepository.findAll(pageable);
