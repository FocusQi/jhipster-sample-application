...
/**
 * REST controller for managing {@link com.mega.project.srm.domain.BiddingOpener}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BiddingOpenerResource {
    ...
    public ResponseEntity<BiddingOpener> createBiddingOpener(@Valid @RequestBody BiddingOpener biddingOpener) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/bidding-openers/" + result.getId()))
    ...
    public ResponseEntity<List<BiddingOpener>> getAllBiddingOpeners(Pageable pageable) {
        log.debug("REST request to get a page of BiddingOpeners");
        Page<BiddingOpener> page = biddingOpenerRepository.findAll(pageable);
