...
import com.mega.project.srm.repository.BomTemplateHeaderRepository;
...
/**
 * REST controller for managing {@link com.mega.project.srm.domain.BomTemplateHeader}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BomTemplateHeaderResource {
    ...
    public ResponseEntity<BomTemplateHeader> createBomTemplateHeader(@Valid @RequestBody BomTemplateHeader bomTemplateHeader)
        ...
        return ResponseEntity
            .created(new URI("/api/bom-template-headers/" + result.getId()))
    ...
    public ResponseEntity<BomTemplateHeader> updateBomTemplateHeader(@Valid @RequestBody BomTemplateHeader bomTemplateHeader)
        throws URISyntaxException {
    ...
    public ResponseEntity<List<BomTemplateHeader>> getAllBomTemplateHeaders(Pageable pageable) {
        log.debug("REST request to get a page of BomTemplateHeaders");
        Page<BomTemplateHeader> page = bomTemplateHeaderRepository.findAll(pageable);
