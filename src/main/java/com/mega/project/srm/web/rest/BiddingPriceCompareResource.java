...
/**
 * REST controller for managing {@link com.mega.project.srm.domain.BiddingPriceCompare}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BiddingPriceCompareResource {
    ...
    public ResponseEntity<BiddingPriceCompare> createBiddingPriceCompare(@Valid @RequestBody BiddingPriceCompare biddingPriceCompare)
        ...
        return ResponseEntity
            .created(new URI("/api/bidding-price-compares/" + result.getId()))
    ...
    public ResponseEntity<BiddingPriceCompare> updateBiddingPriceCompare(@Valid @RequestBody BiddingPriceCompare biddingPriceCompare)
        throws URISyntaxException {
    ...
    public ResponseEntity<List<BiddingPriceCompare>> getAllBiddingPriceCompares(
        Pageable pageable,
        ...
        log.debug("REST request to get a page of BiddingPriceCompares");
        Page<BiddingPriceCompare> page = biddingPriceCompareRepository.findAll(pageable);
