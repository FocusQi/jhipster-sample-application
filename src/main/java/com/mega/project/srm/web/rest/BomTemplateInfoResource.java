...
/**
 * REST controller for managing {@link com.mega.project.srm.domain.BomTemplateInfo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BomTemplateInfoResource {
    ...
    public ResponseEntity<BomTemplateInfo> createBomTemplateInfo(@RequestBody BomTemplateInfo bomTemplateInfo) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/bom-template-infos/" + result.getId()))
    ...
    public ResponseEntity<List<BomTemplateInfo>> getAllBomTemplateInfos(Pageable pageable) {
        log.debug("REST request to get a page of BomTemplateInfos");
        Page<BomTemplateInfo> page = bomTemplateInfoRepository.findAll(pageable);
