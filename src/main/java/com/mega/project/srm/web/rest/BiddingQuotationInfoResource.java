...
/**
 * REST controller for managing {@link com.mega.project.srm.domain.BiddingQuotationInfo}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BiddingQuotationInfoResource {
    ...
    public ResponseEntity<BiddingQuotationInfo> createBiddingQuotationInfo(@Valid @RequestBody BiddingQuotationInfo biddingQuotationInfo)
        ...
        return ResponseEntity
            .created(new URI("/api/bidding-quotation-infos/" + result.getId()))
    ...
    public ResponseEntity<BiddingQuotationInfo> updateBiddingQuotationInfo(@Valid @RequestBody BiddingQuotationInfo biddingQuotationInfo)
        throws URISyntaxException {
    ...
    public ResponseEntity<List<BiddingQuotationInfo>> getAllBiddingQuotationInfos(Pageable pageable) {
        log.debug("REST request to get a page of BiddingQuotationInfos");
        Page<BiddingQuotationInfo> page = biddingQuotationInfoRepository.findAll(pageable);
