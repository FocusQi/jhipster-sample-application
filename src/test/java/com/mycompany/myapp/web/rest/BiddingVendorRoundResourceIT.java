...
public class BiddingVendorRoundResourceIT {
    ...
    public void createBiddingVendorRound() throws Exception {
        ...
        restBiddingVendorRoundMockMvc.perform(post("/api/bidding-vendor-rounds")
    ...
    public void getAllBiddingVendorRounds() throws Exception {
        ...
        restBiddingVendorRoundMockMvc.perform(get("/api/bidding-vendor-rounds?sort=id,desc"))
    ...
    public void getBiddingVendorRound() throws Exception {
        ...
        restBiddingVendorRoundMockMvc.perform(get("/api/bidding-vendor-rounds/{id}", biddingVendorRound.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingVendorRound() throws Exception {
        // Get the biddingVendorRound
        restBiddingVendorRoundMockMvc.perform(get("/api/bidding-vendor-rounds/{id}", Long.MAX_VALUE))
    ...
    public void updateBiddingVendorRound() throws Exception {
        ...
        restBiddingVendorRoundMockMvc.perform(put("/api/bidding-vendor-rounds")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBiddingVendorRound() throws Exception {
        ...
        restBiddingVendorRoundMockMvc.perform(delete("/api/bidding-vendor-rounds/{id}", biddingVendorRound.getId())
