...
public class BiddingMaterialRoundResourceIT {
    ...
    public void createBiddingMaterialRound() throws Exception {
        ...
        restBiddingMaterialRoundMockMvc.perform(post("/api/bidding-material-rounds")
    ...
    public void getAllBiddingMaterialRounds() throws Exception {
        ...
        restBiddingMaterialRoundMockMvc.perform(get("/api/bidding-material-rounds?sort=id,desc"))
    ...
    public void getBiddingMaterialRound() throws Exception {
        ...
        restBiddingMaterialRoundMockMvc.perform(get("/api/bidding-material-rounds/{id}", biddingMaterialRound.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingMaterialRound() throws Exception {
        // Get the biddingMaterialRound
        restBiddingMaterialRoundMockMvc.perform(get("/api/bidding-material-rounds/{id}", Long.MAX_VALUE))
    ...
    public void updateBiddingMaterialRound() throws Exception {
        ...
        restBiddingMaterialRoundMockMvc.perform(put("/api/bidding-material-rounds")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBiddingMaterialRound() throws Exception {
        ...
        restBiddingMaterialRoundMockMvc.perform(delete("/api/bidding-material-rounds/{id}", biddingMaterialRound.getId())
