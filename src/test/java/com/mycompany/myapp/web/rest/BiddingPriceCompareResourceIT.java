...
public class BiddingPriceCompareResourceIT {
    ...
    public void createBiddingPriceCompare() throws Exception {
        ...
        restBiddingPriceCompareMockMvc.perform(post("/api/bidding-price-compares")
    ...
    public void getAllBiddingPriceCompares() throws Exception {
        ...
        restBiddingPriceCompareMockMvc.perform(get("/api/bidding-price-compares?sort=id,desc"))
    ...
    public void getBiddingPriceCompare() throws Exception {
        ...
        restBiddingPriceCompareMockMvc.perform(get("/api/bidding-price-compares/{id}", biddingPriceCompare.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingPriceCompare() throws Exception {
        // Get the biddingPriceCompare
        restBiddingPriceCompareMockMvc.perform(get("/api/bidding-price-compares/{id}", Long.MAX_VALUE))
    ...
    public void updateBiddingPriceCompare() throws Exception {
        ...
        restBiddingPriceCompareMockMvc.perform(put("/api/bidding-price-compares")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBiddingPriceCompare() throws Exception {
        ...
        restBiddingPriceCompareMockMvc.perform(delete("/api/bidding-price-compares/{id}", biddingPriceCompare.getId())
