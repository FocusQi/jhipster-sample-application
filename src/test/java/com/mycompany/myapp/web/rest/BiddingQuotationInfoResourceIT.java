...
public class BiddingQuotationInfoResourceIT {
    ...
    public void createBiddingQuotationInfo() throws Exception {
        ...
        restBiddingQuotationInfoMockMvc.perform(post("/api/bidding-quotation-infos")
    ...
    public void getAllBiddingQuotationInfos() throws Exception {
        ...
        restBiddingQuotationInfoMockMvc.perform(get("/api/bidding-quotation-infos?sort=id,desc"))
    ...
    public void getBiddingQuotationInfo() throws Exception {
        ...
        restBiddingQuotationInfoMockMvc.perform(get("/api/bidding-quotation-infos/{id}", biddingQuotationInfo.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingQuotationInfo() throws Exception {
        // Get the biddingQuotationInfo
        restBiddingQuotationInfoMockMvc.perform(get("/api/bidding-quotation-infos/{id}", Long.MAX_VALUE))
    ...
    public void updateBiddingQuotationInfo() throws Exception {
        ...
        restBiddingQuotationInfoMockMvc.perform(put("/api/bidding-quotation-infos")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBiddingQuotationInfo() throws Exception {
        ...
        restBiddingQuotationInfoMockMvc.perform(delete("/api/bidding-quotation-infos/{id}", biddingQuotationInfo.getId())
