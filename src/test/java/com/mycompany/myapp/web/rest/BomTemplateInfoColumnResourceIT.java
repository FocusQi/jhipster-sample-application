...
public class BomTemplateInfoColumnResourceIT {
    ...
    public void createBomTemplateInfoColumn() throws Exception {
        ...
        restBomTemplateInfoColumnMockMvc.perform(post("/api/bom-template-info-columns")
    ...
    public void getAllBomTemplateInfoColumns() throws Exception {
        ...
        restBomTemplateInfoColumnMockMvc.perform(get("/api/bom-template-info-columns?sort=id,desc"))
    ...
    public void getBomTemplateInfoColumn() throws Exception {
        ...
        restBomTemplateInfoColumnMockMvc.perform(get("/api/bom-template-info-columns/{id}", bomTemplateInfoColumn.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBomTemplateInfoColumn() throws Exception {
        // Get the bomTemplateInfoColumn
        restBomTemplateInfoColumnMockMvc.perform(get("/api/bom-template-info-columns/{id}", Long.MAX_VALUE))
    ...
    public void updateBomTemplateInfoColumn() throws Exception {
        ...
        updatedBomTemplateInfoColumn
            .sortIndex(UPDATED_SORT_INDEX)
            .columnName(UPDATED_COLUMN_NAME)
            .columnValue(UPDATED_COLUMN_VALUE);

        restBomTemplateInfoColumnMockMvc.perform(put("/api/bom-template-info-columns")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBomTemplateInfoColumn() throws Exception {
        ...
        restBomTemplateInfoColumnMockMvc.perform(delete("/api/bom-template-info-columns/{id}", bomTemplateInfoColumn.getId())
