...
import com.mycompany.myapp.repository.BiddingQuotationHeaderRepository;
...
public class BiddingQuotationHeaderResourceIT {
    ...
    public void createBiddingQuotationHeader() throws Exception {
        ...
        restBiddingQuotationHeaderMockMvc.perform(post("/api/bidding-quotation-headers")
    ...
    public void getAllBiddingQuotationHeaders() throws Exception {
        ...
        restBiddingQuotationHeaderMockMvc.perform(get("/api/bidding-quotation-headers?sort=id,desc"))
    ...
    public void getBiddingQuotationHeader() throws Exception {
        ...
        restBiddingQuotationHeaderMockMvc.perform(get("/api/bidding-quotation-headers/{id}", biddingQuotationHeader.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingQuotationHeader() throws Exception {
        // Get the biddingQuotationHeader
        restBiddingQuotationHeaderMockMvc.perform(get("/api/bidding-quotation-headers/{id}", Long.MAX_VALUE))
    ...
    public void updateBiddingQuotationHeader() throws Exception {
        ...
        BiddingQuotationHeader updatedBiddingQuotationHeader = biddingQuotationHeaderRepository.findById(biddingQuotationHeader.getId()).get();
        ...
        restBiddingQuotationHeaderMockMvc.perform(put("/api/bidding-quotation-headers")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBiddingQuotationHeader() throws Exception {
        ...
        restBiddingQuotationHeaderMockMvc.perform(delete("/api/bidding-quotation-headers/{id}", biddingQuotationHeader.getId())
