...
public class BiddingRoundInfoResourceIT {
    ...
    public void createBiddingRoundInfo() throws Exception {
        ...
        restBiddingRoundInfoMockMvc.perform(post("/api/bidding-round-infos")
    ...
    public void getAllBiddingRoundInfos() throws Exception {
        ...
        restBiddingRoundInfoMockMvc.perform(get("/api/bidding-round-infos?sort=id,desc"))
    ...
    public void getBiddingRoundInfo() throws Exception {
        ...
        restBiddingRoundInfoMockMvc.perform(get("/api/bidding-round-infos/{id}", biddingRoundInfo.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingRoundInfo() throws Exception {
        // Get the biddingRoundInfo
        restBiddingRoundInfoMockMvc.perform(get("/api/bidding-round-infos/{id}", Long.MAX_VALUE))
    ...
    public void updateBiddingRoundInfo() throws Exception {
        ...
        restBiddingRoundInfoMockMvc.perform(put("/api/bidding-round-infos")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBiddingRoundInfo() throws Exception {
        ...
        restBiddingRoundInfoMockMvc.perform(delete("/api/bidding-round-infos/{id}", biddingRoundInfo.getId())
