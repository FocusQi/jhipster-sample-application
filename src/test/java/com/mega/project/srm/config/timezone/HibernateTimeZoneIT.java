package com.mega.project.srm.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.mega.project.srm.MegaframeworkApp;
import com.mega.project.srm.repository.timezone.DateTimeWrapper;
import com.mega.project.srm.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM skylineuaa_date_time_wrapper where id=%d", fieldName, id);
    }
