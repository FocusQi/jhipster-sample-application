...
public class PoHeaderResourceIT {
    ...
    public void createPoHeader() throws Exception {
        ...
        // Create the PoHeader
        restPoHeaderMockMvc
            .perform(post("/api/po-headers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(poHeader)))
    ...
    public void getAllPoHeaders() throws Exception {
        ...
        restPoHeaderMockMvc
            .perform(get("/api/po-headers?sort=id,desc"))
    ...
    public void getPoHeader() throws Exception {
        ...
        // Get the poHeader
        restPoHeaderMockMvc
            .perform(get("/api/po-headers/{id}", poHeader.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingPoHeader() throws Exception {
        // Get the poHeader
        restPoHeaderMockMvc.perform(get("/api/po-headers/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updatePoHeader() throws Exception {
        ...
        restPoHeaderMockMvc
            .perform(
                put("/api/po-headers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedPoHeader))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingPoHeader() throws Exception {
        ...
        restPoHeaderMockMvc
            .perform(put("/api/po-headers").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(poHeader)))
            .andExpect(status().isBadRequest());
    ...
    public void deletePoHeader() throws Exception {
        ...
        // Delete the poHeader
        restPoHeaderMockMvc
            .perform(delete("/api/po-headers/{id}", poHeader.getId()).accept(MediaType.APPLICATION_JSON))
