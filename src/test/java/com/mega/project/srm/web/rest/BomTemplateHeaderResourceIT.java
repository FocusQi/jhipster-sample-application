...
public class BomTemplateHeaderResourceIT {
    ...
    public void createBomTemplateHeader() throws Exception {
        ...
        restBomTemplateHeaderMockMvc
            .perform(
                post("/api/bom-template-headers")
    ...
    public void getAllBomTemplateHeaders() throws Exception {
        ...
        restBomTemplateHeaderMockMvc
            .perform(get("/api/bom-template-headers?sort=id,desc"))
    ...
    public void getBomTemplateHeader() throws Exception {
        ...
        restBomTemplateHeaderMockMvc
            .perform(get("/api/bom-template-headers/{id}", bomTemplateHeader.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBomTemplateHeader() throws Exception {
        // Get the bomTemplateHeader
        restBomTemplateHeaderMockMvc.perform(get("/api/bom-template-headers/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteBomTemplateHeader() throws Exception {
        ...
        restBomTemplateHeaderMockMvc
            .perform(delete("/api/bom-template-headers/{id}", bomTemplateHeader.getId()).accept(MediaType.APPLICATION_JSON))
