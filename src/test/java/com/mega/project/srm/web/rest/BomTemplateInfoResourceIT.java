...
import com.mega.project.srm.repository.BomTemplateInfoRepository;
...
public class BomTemplateInfoResourceIT {
    ...
    public void createBomTemplateInfo() throws Exception {
        ...
        restBomTemplateInfoMockMvc
            .perform(
                post("/api/bom-template-infos")
    ...
    public void getAllBomTemplateInfos() throws Exception {
        ...
        restBomTemplateInfoMockMvc
            .perform(get("/api/bom-template-infos?sort=id,desc"))
    ...
    public void getBomTemplateInfo() throws Exception {
        ...
        restBomTemplateInfoMockMvc
            .perform(get("/api/bom-template-infos/{id}", bomTemplateInfo.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBomTemplateInfo() throws Exception {
        // Get the bomTemplateInfo
        restBomTemplateInfoMockMvc.perform(get("/api/bom-template-infos/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteBomTemplateInfo() throws Exception {
        ...
        restBomTemplateInfoMockMvc
            .perform(delete("/api/bom-template-infos/{id}", bomTemplateInfo.getId()).accept(MediaType.APPLICATION_JSON))
