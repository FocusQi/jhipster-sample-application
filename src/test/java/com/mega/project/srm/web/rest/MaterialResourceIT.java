...
public class MaterialResourceIT {
    ...
    public void createMaterial() throws Exception {
        ...
        // Create the Material
        restMaterialMockMvc
            .perform(post("/api/materials").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(material)))
    ...
    public void updateMaterial() throws Exception {
        ...
        restMaterialMockMvc
            .perform(
                put("/api/materials").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedMaterial))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingMaterial() throws Exception {
        ...
        restMaterialMockMvc
            .perform(put("/api/materials").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(material)))
            .andExpect(status().isBadRequest());
