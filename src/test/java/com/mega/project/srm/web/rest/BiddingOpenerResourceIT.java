...
import com.mega.project.srm.repository.BiddingOpenerRepository;
...
public class BiddingOpenerResourceIT {
    ...
    public void createBiddingOpener() throws Exception {
        ...
        restBiddingOpenerMockMvc
            .perform(
                post("/api/bidding-openers")
    ...
    public void getAllBiddingOpeners() throws Exception {
        ...
        restBiddingOpenerMockMvc
            .perform(get("/api/bidding-openers?sort=id,desc"))
    ...
    public void getBiddingOpener() throws Exception {
        ...
        restBiddingOpenerMockMvc
            .perform(get("/api/bidding-openers/{id}", biddingOpener.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingBiddingOpener() throws Exception {
        // Get the biddingOpener
        restBiddingOpenerMockMvc.perform(get("/api/bidding-openers/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void deleteBiddingOpener() throws Exception {
        ...
        restBiddingOpenerMockMvc
            .perform(delete("/api/bidding-openers/{id}", biddingOpener.getId()).accept(MediaType.APPLICATION_JSON))
