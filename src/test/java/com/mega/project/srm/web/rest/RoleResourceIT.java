...
import com.mega.project.srm.repository.RoleRepository;
...
public class RoleResourceIT {
    ...
    public void createRole() throws Exception {
        ...
        // Create the Role
        restRoleMockMvc
            .perform(post("/api/roles").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(role)))
    ...
    public void updateRole() throws Exception {
        ...
        restRoleMockMvc
            .perform(put("/api/roles").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedRole)))
            .andExpect(status().isOk());
    ...
    public void updateNonExistingRole() throws Exception {
        ...
        restRoleMockMvc
            .perform(put("/api/roles").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(role)))
            .andExpect(status().isBadRequest());
    ...
    public void deleteRole() throws Exception {
        ...
        // Delete the role
        restRoleMockMvc
            .perform(delete("/api/roles/{id}", role.getId()).accept(MediaType.APPLICATION_JSON))
